...
trait TAdminBaseController
{
    ...
    public function __construct(Request $request) {
        ...
        view()->share(compact('class', 'c','model', 'table', 'route', 'view', 'belongTable', 'belongRoute', 'relatedTables', 'relatedDelete', 'relatedTables', 'relatedMethods', 'relatedManyToOne'));
    }
    ...
    public function edit($id)
    {
        ...
        // Передаём данные в вид
        return view("{$this->viewPath}.{$this->view}.{$this->template}", compact('title', 'values', 'all', 'valuesBelong', 'currentParent', 'related', $this->table, 'relatedManyToOneItems'));
    }
